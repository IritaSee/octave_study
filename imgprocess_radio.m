function mygui()
  ...
  hBtnGrp = uibuttongroup('Position',[600 75 400 40], 'Units','pixels');
  
  uicontrol ("style", "radiobutton",'Parent',hBtnGrp,
                                    "units", "pixels",
                                    "string", "recover colour",
                                    "Tag","1",
                                    "position", [30 75 150 40]);
                                    
  uicontrol ("style", "radiobutton",'Parent',hBtnGrp,
                                    "units", "pixels",
                                    "string", "colour layer",
                                    "Tag","0",
                                    "position", [60 25 150 40]);
                                    
                                    
  check1=uicontrol('style','checkbox','position',[770 25 50 50]
  ,'string','R');
  check2=uicontrol('style','checkbox','position',[820 25 50 50]
  ,'string','G');
  check3=uicontrol('style','checkbox','position',[870 25 50 50]
  ,'string','B');
 ...
 'string', 'browse','fontsize',14 ,'callback', {@bukafile ax1});
  ...
  push3=uicontrol('style','pushbutton','position',[1000 75 100 40],
  'string', 'recolour','fontsize',14 ,'callback', {@recolour edit4,edit5,edit6,edit1,edit2,edit3,ax3,check1,check2,check3});
...
function recolour(hObject,eventdata,edit4,edit5,edit6,edit1,edit2,edit3,ax3,isRecover,isLayer,check1,check2,check3)
  load grey.mat
  a=str2double(get(edit4,'string'));
  b=str2double(get(edit5,'string'));
  c=str2double(get(edit6,'string'));
  r_rat=str2double(get(edit1,'string'));
  g_rat=str2double(get(edit2,'string'));
  b_rat=str2double(get(edit3,'string'));
  greyval=grey;
